...
public class ViewModelSerializerTests
{
    ...
    public void DeserializationOfDoubleShouldWorkWithCurrentAndInternationalFormat()
    {
        ...
        var obj = ViewModelProvider.DeserializePropertyValue(_logger, "Test", json, typeof(SimpleClass)) as SimpleClass;
        Assert.NotNull(obj);
        Assert.Equal(5.0, obj.FloatingPoint);

        var value = 5.3.ToString(CultureInfo.InvariantCulture);
        json = $"{{ \"FloatingPoint\": \"{value}\" }}";
        obj = ViewModelProvider.DeserializePropertyValue(_logger, "Test", json, typeof(SimpleClass)) as SimpleClass;
        Assert.NotNull(obj);
    ...
    {
        var json = "{ \"Wieviel\": \"5\" }";
        var obj = ViewModelProvider.DeserializePropertyValue(_logger, "Test", json, typeof(SimpleClass));
        Assert.NotNull(obj);
    }
    ...
    public void DeserializationShouldDeserializeClass()
    {
        ...
        var obj = ViewModelProvider.DeserializePropertyValue(_logger, "Test", json, typeof(object));
        Assert.NotNull(obj);
    }
    ...
    public void DeserializationShouldDeserializeArrayOfClassToList()
    {
        ...
        var listSimpleClass = ViewModelProvider
                .DeserializePropertyValue(_logger, "Test", json, typeof(List<SimpleClass>))
            as List<SimpleClass>;
    ...
    public void DeserializationShouldDeserializeArrayOfClassToArray()
    {
        ...
        var arraySimpleClass = ViewModelProvider
                .DeserializePropertyValue(_logger, "Test", json, typeof(SimpleClass[]))
            as SimpleClass[];
